...
AtlasLootItems = {
	...
	MCTrashMobs = {
		...
		{ 17012,"INV_Ammo_FireTar","=q=Core Leather","=ds=#m31#" },
   ...
   WCDeviateFaerieDragon = {
    ...
    BRDTheVault = {
        ...
        { 11945, "INV_Jewelry_Ring_15", "=q3=Dark Iron Ring", "=ds=#s13# =q2=#e31#", "0.53%" },
        { 11946, "INV_Jewelry_Necklace_02", "=q3=Fire Opal Necklace", "=ds=#s2# =q2=#e31#", "0.41%" },
        { 0, "", "", "" },
  ...
  -------------------------------------
    ...
    STRATArchivistGalford = {
        ...
        { 0, "", "", "", "" },
        { 22897, "INV_Misc_Book_07", "=q3=Tome of Conjure Food VII", "=ds=#e20# =q10=#c3#", "4.86%" },
        };
    ...
    STRATBalnazzar = {
		...
		{ 0, "", "", "", "" },
		{ 13250, "Spell_Shadow_Possession", "=g1=Head of Balnazzar", "=ds=#m2#" },
        };
    ...
    LBRSVoone = {
        ...
        { 0, "", "", "", "" },
        { 12335, "INV_Misc_Gem_Opal_01", "=q2=Gemstone of Smoulderthorn", "=ds=#m8#", "21.43%" },
        };
