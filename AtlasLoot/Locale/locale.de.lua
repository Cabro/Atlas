...
AL:RegisterTranslations("deDE", function() return {
    ...
    ["New feature in 4.05.00: Advanced searching functionality is now available. You can type in a partial item name, for example typing 'elixir' gives all items in the database with 'elixir' in the name.  Big thanks to Kurax for his help."] = "Die erweiterte Suchfunktion ist jetzt verfügbar. Ihr könnt nun einen Teil des Gegenstandnamens eingeben, so zeigt euch z.B. die Eingabe 'Elexir' alle Gegenstände aus der Datenbank mit dem Wort 'Elexir' im Namen an. Vielen Dank an Kurax für seine Hilfe.",
    ["New feature in 4.05.00: All professions are now included in the AtlasLoot_Crafting module."] = "Alle Berufe sind im nun im AtlasLoot_Crafting Modul enthalten.",
